...
(function (J, d) {
  'use strict'; function A (d) { k && d.get('$route') } function B (t, u, g) {
    ...
    y, F, G, z = d.module('ngRoute', []).info({angularVersion: '1.6.7'}).provider('$route', function () {
      ...
      }; this.caseInsensitiveMatch = !1; this.otherwise = function (a) { typeof a === 'string' && (a = {redirectTo: a}); this.when(null, a); return this }; k = !0; this.eagerInstantiationEnabled = function (a) { return F(a) ? (k = a, this) : k }; this.$get = ['$rootScope', '$location', '$routeParams', '$q', '$injector', '$templateRequest', '$sce', '$browser', function (a, f, b, c, m, k, u, n) {
        function p (e) {
...
(c = c(a.params)), d.isDefined(c) && (a.loadedTemplateUrl = u.valueOf(c), b = k(c))); return b
          ...
          var c = []; d.forEach((a || '').split(':'),
            function (a, d) { if (d === 0)c.push(a); else { var e = a.match(/(\w+)(?:[?*])?(.*)/), f = e[1]; c.push(b[f]); c.push(e[2] || ''); delete b[f] } }); return c.join('')
        } var D = !1, s, y, q = {routes: g,
          reload: function () { D = !0; var b = {defaultPrevented: !1, preventDefault: function () { this.defaultPrevented = !0; D = !1 }}; a.$evalAsync(function () { p(b); b.defaultPrevented || l() }) },
